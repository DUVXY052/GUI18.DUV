 ...
 * @author USER
 */
public class Layaou extends javax.swing.JFrame {

    /**
     * Creates new form Layaou
     */
    public Layaou() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Layaou.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
